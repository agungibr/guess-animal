  ...
  return (
    <View style={styles.snake}>
      ...
      <View style={[styles.view1, styles.viewLayout]}>
        <View style={styles.kotak} />
        <Text style={[styles.snake1, styles.catTypo]}>Snake</Text>
      </View>
      ...
      />
      <Image
        style={styles.kisspngSnakeAnimationCartooIcon}
        resizeMode="cover"
        source={require("../../assets/kisspngsnakeanimationcartoonclipartsnake5ab42cd4819763.png")}
      />
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  kisspngSnakeAnimationCartooIcon: {
    top: 180,
    left: 95,
    width: 185,
    height: 226,
