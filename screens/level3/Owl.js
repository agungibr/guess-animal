  ...
  return (
    <View style={styles.owl}>
      ...
      <View style={[styles.view2, styles.viewLayout]}>
        <View style={styles.kotak} />
        <Text style={[styles.owl1, styles.catTypo]}>Owl</Text>
      </View>
      ...
      />
      <Image
        style={styles.pngtreeOwlClipartStandingTIcon}
        resizeMode="cover"
        source={require("../../assets/pngtreeowlclipartstandingthickbrowedowlcartoonillustrationclipartpngimage-5532605removebgpreview.png")}
      />
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  pngtreeOwlClipartStandingTIcon: {
    top: 144,
    left: 47,
    width: 284,
    height: 284,
